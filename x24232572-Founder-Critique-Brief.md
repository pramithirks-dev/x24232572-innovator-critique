# GajaLens - Founder's Critique Brief
...
**File:** index.html (feature grid, Solution section)

**Quoted line:** *"Crop-loss insured. Bundled ICICI Lombard guarantee. If a tusk touches your harvest, we pay."*
...
**File:** index.html (hero section overlay)

**Quoted lines:** *"Sentinel Pod #042 - Wayanad"* and *"Herd detected - Karuna deployed"*
...
**File:** index.html (stats band below the hero)

**Quoted line:** *"94% - Elephant detection accuracy of our edge-AI model"*
